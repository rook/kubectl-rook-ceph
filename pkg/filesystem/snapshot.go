...
func SnapshotList(ctx context.Context, clientsets *k8sutil.Clientsets, operatorNamespace, clusterNamespace, subvolgName string, orphanedOnly bool) {
...
// It first deletes the omap object and key, then deletes the snapshot itself
