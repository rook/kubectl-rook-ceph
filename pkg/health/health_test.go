...
func TestWorseStatus(t *testing.T) {
	tests := []struct {
		...
		{"OK+Unknown", StatusOK, StatusUnknown, StatusUnknown},
		...
		{"Warning+Unknown", StatusWarning, StatusUnknown, StatusWarning},
		...
		{"Critical+Unknown", StatusCritical, StatusUnknown, StatusCritical},
		{"Unknown+OK", StatusUnknown, StatusOK, StatusUnknown},
		{"Unknown+Warning", StatusUnknown, StatusWarning, StatusWarning},
		{"Unknown+Critical", StatusUnknown, StatusCritical, StatusCritical},
		{"Unknown+Unknown", StatusUnknown, StatusUnknown, StatusUnknown},
	}
